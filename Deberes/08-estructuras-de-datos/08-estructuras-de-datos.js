...
function añadir(array) {
    return __awaiter(this, void 0, void 0, function () {
        var arregloNumero, arregloA, indice, contador, contador, contador;
        return __generator(this, function (_a) {
            ...
            for (contador = indice; contador < array.length; contador++) {
                arregloA[contador] = arregloNumero[contador];
            }
            //arregloNumero[indice].nombre=nuevoNinja.nombre;
            for (contador = indice + 1; contador < array.length + 1; contador++) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prompts(indiceA)];
                case 1:
                    indiceB = _a.sent();
                    indice = indiceB;
